...
class DRLGazebo(Node):
    def __init__(self):
        ...
        ************************************************************"""
        ...
        #### Below is the HardCoded Path #####
        self.entity_dir_path = "/home/turtlebot3_drlnav/install/turtlebot3_gazebo/share/turtlebot3_gazebo/models/turtlebot3_drl_world/goal_box"
        self.entity_path = os.path.join(self.entity_dir_path, 'model.sdf')
            # Debugging logs
        print(f"Entity directory path: {self.entity_dir_path}")
        print(f"Entity path: {self.entity_path}")
